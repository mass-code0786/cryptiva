...
const WalletCard = ({ depositWallet, withdrawalWallet, tradingWallet }: WalletCardProps) => {
  return (
    <div className="rounded-2xl border border-wallet-border bg-gradient-to-br from-wallet-panel to-wallet-bg p-4 shadow-xl">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 text-xs md:grid-cols-3">
        ...
        <div className="rounded-xl bg-wallet-panelAlt/60 p-2">
          ...
          <p className="text-2xl font-bold text-wallet-accentAlt">${depositWallet.toFixed(2)}</p>
        </div>
        <div className="rounded-xl bg-wallet-panelAlt/60 p-2">
